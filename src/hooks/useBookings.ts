...
export function useCreateBooking() {
  ...
  return useMutation({
    mutationFn: async (booking: Omit<Booking, "id" | "trainer_id" | "created_at" | "reminder_24h_sent" | "reminder_1h_sent" | "cancellation_reason" | "cancelled_at" | "cancelled_by" | "late_minutes" | "attendance_confirmed_at" | "chase_sent_at" | "payment_status" | "payment_amount" | "client_paid_at" | "pt_confirmed_at" | "payment_reminder_sent_at">) => {
